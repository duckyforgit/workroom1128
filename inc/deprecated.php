...
if ( ! function_exists( 'workroom1128_adjust_body_class' ) ) {
	 ...
	 */
	function workroom1128_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'workroom1128_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function workroom1128_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'workroom1128' ),
		__( 'Previous', 'workroom1128' ),
		__( 'Next', 'workroom1128' ),
		__( 'About:', 'workroom1128' ),
		__( 'Profile', 'workroom1128' ),
		__( 'Posts by', 'workroom1128' ),
		__( 'Permanent Link:', 'workroom1128' ),
		__( 'in', 'workroom1128' ),
		__( 'Edit', 'workroom1128' ),
	);
}
