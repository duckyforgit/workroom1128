...
if ( ! function_exists( 'workroom1128_pagination' ) ) {
	/**
	 ...
	 */
	function workroom1128_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'workroom1128' ),
				'next_text'          => __( '&raquo;', 'workroom1128' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'workroom1128' ),
			)
		);
