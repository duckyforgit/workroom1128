...
class Recent_Posts_Sidebar_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Recent Posts Sidebar(workroom1128)', 'workroom1128' ),  
			array(
				'classname' => 'recent-posts-sidebar',
				'description' => esc_html__( 'Displays recent posts in sidebar.', 'workroom1128' ),
	...
	function postmeta( $settings ) {
		...
		if ( true == $settings['meta_author'] ) : ?>
			...
			<span class="meta-author meta-author">
				<?php printf('<a href="%1$s" title="%2$s" rel="author">%3$s</a>',
					...
					esc_attr( sprintf( esc_html__( 'View all posts by %s', 'workroom1128' ), get_the_author() ) ),
					get_the_author()
				);?>
			</span>
		...
		if ( true == $settings['meta_comments'] and comments_open() ) : ?>
			...
			<span class="meta-comments">
				<?php comments_popup_link( esc_html__( 'No comments', 'workroom1128' ), esc_html__( 'One comment','workroom1128' ), esc_html__( '% comments','workroom1128' ) ); ?>
			</span>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php esc_html_e( 'Select Category:', 'workroom1128' ); ?></label><br/>
			<?php
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php esc_html_e( 'Order by:', 'workroom1128' ); ?></label><br/>
			<select name="<?php echo $this->get_field_name( 'order' ); ?>" id="<?php echo $this->get_field_id( 'order' ); ?>">
				<option <?php selected( $settings['order'], 'date' ); ?> value="date"><?php esc_html_e( 'Post Date', 'workroom1128' ); ?></option>
				<option <?php selected( $settings['order'], 'comment_count' ); ?> value="comment_count"><?php esc_html_e( 'Comment Count', 'workroom1128' ); ?></option>
				<option <?php selected( $settings['order'], 'rand' ); ?> value="rand"><?php esc_html_e( 'Random', 'workroom1128' ); ?></option>
			</select>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts:', 'workroom1128' ); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumbnails' ); ?>">
				...
				<?php esc_html_e( 'Display post thumbnails', 'workroom1128' ); ?>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_date' ); ?>">
				...
				<?php esc_html_e( 'Display post date', 'workroom1128' ); ?>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_author' ); ?>">
				...
				<?php esc_html_e( 'Display post author', 'workroom1128' ); ?>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_comments' ); ?>">
				...
				<?php esc_html_e( 'Display post comments', 'workroom1128' ); ?>
			</label>
		</p>
