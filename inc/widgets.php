...
if ( ! function_exists( 'workroom1128_widgets_init' ) ) {
	...
	function workroom1128_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer widgets right top', 'workroom1128' ),
				'id'            => 'footer-widgets-right-top',
				'description'   => __( 'Drag widgets to this footer container', 'workroom1128' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<div class="widget-header"><h5 class="widget-title">',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer widgets right bottom', 'workroom1128' ),
				'id'            => 'footer-widgets-right-bottom',
				'description'   => __( 'Drag widgets to this footer container', 'workroom1128' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<div class="widget-header"><h5 class="widget-title">',
		...
		require_once $workroom1128_inc_dir . '/widgets/widget-recent-posts-template.php';  // Recent posts widget.
		require_once $workroom1128_inc_dir . '/widgets/widget-gallery.php';   // Custom widget.
		require_once $workroom1128_inc_dir . '/widgets/widget-tabbed-content-template.php';   // Custom widget.
		require_once $workroom1128_inc_dir . '/widgets/widget-business-info-template.php';   // Custom widget.
		register_widget( 'Recent_Posts_Sidebar_Widget' );
		register_widget( 'workroom1128_Widget_Gallery' );
