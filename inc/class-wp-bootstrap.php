...
/*
 * Class Name:  WP_Bootstrap
 * Plugin Name:  WP_Bootstrap
...
if ( ! class_exists( 'WP_Bootstrap' ) ) {
	...
	class WP_Bootstrap extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( '_blank' === $item->target && empty( $item->xfn ) ) { // Thanks to LukaszJaro, see https://github.com/workroom1128/workroom1128/issues/973.
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				$fallback_output .= '>';
				$fallback_output .= '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'workroom1128' ) . '">' . esc_html__( 'Add a menu', 'workroom1128' ) . '</a></li>';
				$fallback_output .= '</ul>';
				if ( $container ) {
					$fallback_output .= '</' . esc_attr( $container ) . '>';
				}
