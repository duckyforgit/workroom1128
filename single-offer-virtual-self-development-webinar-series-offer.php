<?php
/**
 * The template for displaying single offer webinar speaker series
 *
	...
	<div class="container" id="content" tabindex="-1">
		...
		<div class="row">
			...
			<?php echo esc_html( workroom1128_custom_breadcrumb() ); ?>
						...
						<section id="webinar-series" class="offers"> 
							<div class="grid-wrapper webinar-series mt-5">
								<div class="box-1 justify-content-center flex-column align-items-center text-white grid-box-shadow">
									<h2 class="display-5 text-shadow pe-5 ps-5">ENGAGE THROUGH A VIRTUAL SELF DEVELOPMENT COURSE</h2>
								</div>
								<div class="box-2 grid-box-shadow img31"></div>
								<div class="box-3 box-3--growth img35 align-items-start flex-column grid-box-shadow ps-2 pe-2">
									<h3 class="pb-2" ></h3>
									<h3></h3>
								</div>
								...
								<div class="box-5 align-items-start flex-column justify-content-center grid-box-shadow ps-2 pe-2">
									<h4 class=" text-center text-shadow-black ">Themes are flexible and will integrate organization objectives.</h4>
								</div>
								...
								<div class="box-8 flex-column justify-content-center background-primary grid-box-shadow">
									...
									<div class="btn-group">
									<button role="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#virtualSelfDevModal">I am interested in this webinar series, let&#39;s chat!</button>
									</div>
								</div>
							</div>
						</section>
								...
								<div class="row mt-5" style="justify-content:center">
									<div class="col-sm-12 col-lg-6" >
										<div class="button-wrapper d-flex justify-content-center">
											<button role="button" class="btn btn-primary larger" data-bs-toggle="modal" data-bs-target="#virtualSelfDevModal" ><h3>Yes, I am interested in a Virtual Self-Development Webinar Series and I&#39;d like more information!</h3></button>
										</div>
									</div>
								</div>
							</div>
				...
				?>
				<div class="modal" id="virtualSelfDevModal" tabindex="-1" aria-labelledby="virtualSelfDevModal" aria-hidden="true">
