				...
				while ( have_posts() ) {
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<section id="webinar-series" class="offers">
							...
							<div class="grid-wrapper webinar-series">
								...
								<div class="box-3 box-3--growth align-items-start flex-column grid-box-shadow ps-2 pe-2">
									<h3 class="text-shadow-black " >Generate self-authority, authenticity, and critical thinking to create a healthy career.</h3>
								...
								<div class="box-8 flex-column justify-content-center background-primary grid-box-shadow">
									...
									<div class="btn-group">
										<a href="#nf-form-11-cont" role="button" class="btn btn btn-outline-light m-2 mt-4">I am interested in this webinar series, let&#39;s chat!</a>
									</div>
								</div>
							</div>
						</section>
