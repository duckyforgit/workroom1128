					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<section id="group-course" class="offers">
							...
							<div class="grid-wrapper group-course">
								...
								<div class="box-2"></div>
								<div class="box-3 align-items-center flex-column grid-box-shadow ps-2 pe-2">
									<div class="box-3--growth"></div>
									<h3 class="h4">Course Premise:</h3>
									<h3><span class="">Professional</span> growth comes from <span class="">personal</span> growth.</h3>
								</div>
								<div class="box-4 grid-box-shadow img30">
								</div>
								<div class="box-5 align-items-start flex-column grid-box-shadow ps-5 pe-5">
								...
								<div class="box-6 grid-box-shadow">
								</div>
								<div class="box-7 justify-content-center align-items-center grid-box-shadow">
									<div class="d-flex flex-column justify-content-center ps-5 pe-2">
								...
								<div class="box-8 giant grid-box-shadow img31">
								</div>
								<div class="box-9 tall wide d-flex flex-column justify-content-center background-primary grid-box-shadow">
									...
									<h3 class="h2 text-white ps-3 pe-1 pt-2 text-center text-shadow">Interested in the virtual self development series?<br>Let's talk about it!</h3>
									<button type="button" class="btn btn-outline-light m-2" data-bs-toggle="modal" data-bs-target="#groupCourseModal" aria-controls="consultation" aria-haspopup="true" tabindex="0">I am interested in this group course, let’s chat!</button>								
								</div>								
							</div>
							<div class="entry-content mt-5">							
								<?php
								the_content();
								// Commented workroom1128_link_pages();. phpcs:ignore Squiz.PHP.CommentedOutCode.Found temporary condition.
								?>
							</div>
							<footer class="entry-footer">
								<!-- edit button which is only visible if logged in -->
								<?php // Commented workroom1128_entry_footer();. phpcs:ignore Squiz.PHP.CommentedOutCode.Found temporary condition. ?>
							</footer>
						</section>
