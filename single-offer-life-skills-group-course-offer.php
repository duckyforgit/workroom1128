	...
	<div class="container" id="content" tabindex="-1">
		...
		<div class="row">
			...
			<main class="site-main" id="main">
						...
						<section id="group-course" class="offers"> 
							<div class="grid-wrapper group-course mt-5">
								...
								<div class="box-4 grid-box-shadow">
									<h4 class="h5 text-shadow-black line-height-15 ps-2 pe-2" >This course was designed to help students and professionals build a solid internal foundation (including but not limited to upgrading their self-awareness, interpersonal skills, emotional intelligence, decision-making, etc.) which translates to a solid external career.</h4>
								</div>
								...
								<div class="box-8 align-items-stretch flex-column grid-box-shadow ps-5 pe-5">
									<div class="d-flex flex-row align-items-center justify-content-start pb-2 pt-4">
										<h3 class="h2 text-center text-shadow-black"><span style="font-weight:600">Professional</span> growth comes from <span style="font-weight:600">personal</span> growth.</h3>
									</div>
								</div> 
								<div class="box-9">									
									<div class="boxx h d-flex flex-column align-items-center justify-content-center grid-box-shadow ps-sm-1 ps-md-2"> 
										...
										<div class="d-flex flex-row justify-content-center align-items-center">
											...
											<h3 class="h3 text-shadow-black pe-2 m-0">Happy employees are productive employees!</h3>
										</div>
										<h4 class="h5 ps-2">Empower and enable your employees to create a healthy life and a robust career!</h4>
									</div>
									<div class="boxx i grid-box-shadow img30">
									</div>
									<div class="boxx j grid-box-shadow img31">
									</div>
								</div>
								<div class="box-10 d-flex flex-column justify-content-center grid-box-shadow">
									...
									<button type="button" class="btn btn-outline-light mt-2" data-bs-toggle="modal" data-bs-target="#virtualWebinarModal" aria-controls="consultation" aria-haspopup="true" tabindex="0">I am interested in this group course, let&#39;s chat!</button>								
								</div>						
							</div>
								...
								<div class="row mt-5" style="justify-content:center">
									<div class="col-sm-12 col-lg-6" >
										<div class="button-wrapper d-flex justify-content-center">
											<button role="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#virtualWebinarModal" aria-controls="consultation" aria-haspopup="true" tabindex="0">I am interested in this group course, let's chat!</button>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="modal" id="virtualWebinarModal" tabindex="-1" aria-labelledby="virtualWebinarModal" aria-hidden="true">
